...
const TermCountdown = () => {
  ...
  return (
    <section className="py-12 bg-gradient-to-r from-fuchsia-600 to-purple-600 relative overflow-hidden">
      {/* Animated background elements */}
      <div className="absolute inset-0 cyber-grid opacity-20"></div>
      <div className="absolute top-4 right-4 w-20 h-20 bg-cyan-400/20 rounded-full blur-xl animate-pulse"></div>
      <div className="absolute bottom-4 left-4 w-16 h-16 bg-fuchsia-400/20 rounded-full blur-xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-4 gap-4 max-w-2xl mx-auto mb-8">
          {[
            ...
            <Card key={unit.label} className="cyber-card p-4 text-center animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
