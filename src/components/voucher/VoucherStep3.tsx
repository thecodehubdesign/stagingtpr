      ...
      <div className="space-y-6">
        <div className="border border-blue-200 rounded-lg p-4 bg-blue-50">
          <div className="flex items-center space-x-2 mb-3">
            ...
            <h4 className="text-blue-800 font-semibold">Need Help Choosing?</h4>
          </div>
        ...
        {formData.wantsEnrollmentCall === false && (
          <div>
            <h4 className="font-medium text-gray-900 mb-4">Available Vouchers</h4>
            <RadioGroup 
              value={formData.selectedVoucher} 
              onValueChange={(value) => updateFormData({ selectedVoucher: value })} 
              className="space-y-4"
            >
                ...
                <div key={voucher.id}>
                  ...
                  <Label htmlFor={voucher.id} className="cursor-pointer">
                    <Card className={`border-2 transition-all duration-200 ${
                      formData.selectedVoucher === voucher.id 
