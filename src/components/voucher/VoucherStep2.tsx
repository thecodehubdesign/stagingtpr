      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          whenToStart: value
            ...
            <SelectContent>
              {startTimeOptions.map(option => <SelectItem key={option} value={option}>
                  {option}
                </SelectItem>)}
            </SelectContent>
          </Select>
        ...
        <div>
          ...
          priorExperience: value
            ...
            <SelectContent>
              {experienceOptions.map(option => <SelectItem key={option} value={option}>
                  {option}
                </SelectItem>)}
            </SelectContent>
          </Select>
        ...
        <div>
          ...
          fitnessLevel: value
            ...
            <SelectContent>
              {fitnessLevels.map(level => <SelectItem key={level} value={level}>
                  {level}
                </SelectItem>)}
            </SelectContent>
          </Select>
