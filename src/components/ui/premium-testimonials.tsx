...
const testimonials = [
  {
    ...
    rating: 5,
    text: "I never thought I could be graceful until I started pole fitness. The confidence I've gained is incredible, and I've made amazing friends in class.",
    results: ["Increased confidence", "Amazing flexibility", "Supportive community"]
  },
  {
    name: "Jessica Chen",
    role: "Working Mom",
    ...
    rating: 5,
    text: "Aerial fitness gave me the strength I never knew I had. It's my escape from daily stress and the instructors are incredibly supportive.",
    results: ["Stress relief", "Core strength", "Personal achievement"]
  },
  {
    ...
    rating: 5,
    text: "The technique and artistry I've learned here has elevated my own dance teaching. The progression system is perfect for all skill levels.",
    results: ["Enhanced technique", "Artistic growth", "Teaching inspiration"]
  },
  {
    name: "Rachel Kim",
    ...
    rating: 5,
    text: "Combining pole with my yoga practice has been transformative. The strength and flexibility gains are beyond what I imagined possible.",
    results: ["Strength gains", "Flexibility boost", "Mind-body connection"]
  },
  {
    ...
    rating: 5,
    text: "This studio fits perfectly into my busy schedule. The classes are challenging yet accessible, and I love how strong I feel.",
    results: ["Flexible scheduling", "Full-body workout", "Empowerment"]
  }
];
      ...
      >
        ...
        >
          {[
            ...
            { number: "5+", label: "Studio Locations" }
          ].map((stat, index) => (
            <motion.div
              key={index}
