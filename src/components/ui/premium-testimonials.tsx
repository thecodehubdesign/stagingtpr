...
export function PremiumTestimonials() {
  ...
  return <section id="testimonials" className="relative py-32 cyber-grid overflow-hidden">
      {/* Enhanced Background Effects */}
      <div className="absolute inset-0">
        {/* Animated gradient mesh */}
        <motion.div className="absolute inset-0 bg-gradient-to-br from-fuchsia-500/[0.08] via-purple-500/[0.05] to-cyan-500/[0.08]" animate={{
        ...
        {/* Moving light orbs */}
        <motion.div className="absolute top-1/3 left-1/5 w-72 h-72 bg-fuchsia-400/15 rounded-full blur-3xl" animate={{
        x: [0, 150, 0],
        y: [0, 80, 0],
        scale: [1, 1.2, 1]
      }} transition={{
        ...
        <motion.div className="absolute bottom-1/3 right-1/5 w-80 h-80 bg-cyan-400/15 rounded-full blur-3xl" animate={{
        x: [0, -100, 0],
        y: [0, -60, 0],
        scale: [1, 1.3, 1]
      }} transition={{
        ...
        {/* Floating particles */}
        {[...Array(12)].map((_, i) => <motion.div key={i} className="absolute w-1 h-1 bg-fuchsia-400/50 rounded-full" style={{
        left: `${15 + i * 7}%`,
        top: `${25 + i * 5}%`
      }} animate={{
        y: [0, -50, 0],
      ...
      margin: "-100px"
        ...
        <motion.div className="text-center mb-20" variants={fadeInUp}>
          <motion.div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/[0.08] border border-fuchsia-500/30 backdrop-blur-sm mb-6" whileHover={{
          scale: 1.05,
        ...
        <div className="relative max-w-6xl mx-auto mb-16">
            ...
            <AnimatePresence initial={false} custom={direction}>
              ...
              rotateY: {
                ...
                <div className="relative h-full cyber-card p-8 md:p-12 overflow-hidden group">
                  ...
                  <motion.div className="absolute inset-0 bg-gradient-to-br from-fuchsia-500/[0.08] via-purple-500/[0.05] to-cyan-500/[0.08] rounded-lg" animate={{
                  backgroundPosition: ['0% 0%', '100% 100%', '0% 0%']
                }} transition={{
                  duration: 15,
                  repeat: Infinity,
                  ...
                  <div className="relative z-10 h-full flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="flex-shrink-0 text-center md:text-left">
                      ...
                      duration: 0.3
                        ...
                        <div className="w-24 h-24 mx-auto md:mx-0 rounded-full overflow-hidden border-4 border-fuchsia-400/30 relative">
                          ...
                          <motion.div className="absolute inset-0 bg-gradient-to-br from-fuchsia-400/20 to-cyan-400/20" animate={{
                          opacity: [0, 0.3, 0]
                        }} transition={{
                          duration: 3,
                          repeat: Infinity
                        ...
                        <motion.div className="absolute inset-0 border-2 border-fuchsia-400/30 rounded-full" animate={{
                        scale: [1, 1.4, 1],
                        opacity: [0.5, 0, 0.5]
                      }} transition={{
                        duration: 2,
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        {testimonials[currentIndex].results.map((result, i) => <motion.div key={i} className="bg-white/[0.05] rounded-lg p-3 border border-fuchsia-500/20 backdrop-blur-sm" initial={{
                        opacity: 0,
                        y: 20
                      }} animate={{
                        opacity: 1,
          ...
          <div className="flex justify-center items-center gap-6 mt-8">
            <motion.button onClick={prevTestimonial} className="p-3 rounded-full bg-white/[0.08] border border-fuchsia-500/30 backdrop-blur-sm text-white hover:bg-fuchsia-500/20 transition-all" whileHover={{
            scale: 1.1,
            ...
            }} className={`w-3 h-3 rounded-full transition-all ${index === currentIndex ? 'bg-fuchsia-400 scale-125' : 'bg-white/30 hover:bg-white/50'}`} whileHover={{
              scale: 1.2
            }} whileTap={{
              scale: 0.9
            }} />)}
            ...
            <motion.button onClick={nextTestimonial} className="p-3 rounded-full bg-white/[0.08] border border-fuchsia-500/30 backdrop-blur-sm text-white hover:bg-fuchsia-500/20 transition-all" whileHover={{
            scale: 1.1,
            backgroundColor: "rgba(255, 0, 255, 0.2)"
          }} whileTap={{
            scale: 0.95
        ...
        <motion.div className="grid grid-cols-2 md:grid-cols-4 gap-8" variants={staggerContainer}>
          ...
          scale: 1.05
              ...
              <motion.div className="text-3xl md:text-4xl font-bold gradient-text mb-2" animate={{
            opacity: [0.7, 1, 0.7]
          }} transition={{
            duration: 2,
            repeat: Infinity,
