...
const BookingStep3 = ({ formData, updateFormData, onPrev, onComplete }: BookingStep3Props) => {
          ...
          <div className="space-y-4">
            <div>
              ...
              <Select 
                ...
                onValueChange={(value) => updateFormData({ selectedStudio: value })}
              >
                <SelectTrigger>
            ...
            <div>
              ...
              <Select 
                ...
                onValueChange={(value) => updateFormData({ selectedTimeSlot: value })}
              >
                <SelectTrigger>
