        ...
        {reviews.length > 3 && (
          <div className="text-center">
            <Button
              ...
              className="bg-fuchsia-500/10 border-fuchsia-500/30 text-fuchsia-400 hover:bg-fuchsia-500/20 hover:text-fuchsia-300 px-8 py-6 text-lg"
            >
              {showAll ? 'Show Less Reviews' : `Show More Reviews (${reviews.length - 3} more)`}
